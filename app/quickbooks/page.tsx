      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', borderBottom: '0.5px solid var(--border)', flexShrink: 0 }}>
        ...
        <div style={card}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
            ...
            <button className='btn btn-primary' onClick={() => exportCSV('income')}>⬇ Export CSV</button>
          </div>
        ...
        <div style={card}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
            ...
            <button className='btn btn-primary' onClick={() => exportCSV('expenses')}>⬇ Export CSV</button>
          </div>
