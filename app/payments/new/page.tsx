...
export default function RecordPaymentPage() {
  ...
  const inp = { width: '100%', padding: '8px 11px', fontSize: '13px', border: '0.5px solid rgba(255,255,255,0.12)', borderRadius: '7px', background: '#1E1E1B', color: '#F0EEE8', outline: 'none', boxSizing: 'border-box' }
  const lbl = { display: 'block', fontSize: '10px', fontWeight: 700, textTransform: 'uppercase', color: '#5A5A56', marginBottom: '4px' }
  ...
  const secTtl = { fontSize: '11px', fontWeight: 700, textTransform: 'uppercase', color: '#5A5A56', marginBottom: '12px' }
    ...
    <AppShell>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '20px' }}>
        ...
        <div style={card}>
          ...
          <textarea style={{ ...inp, resize: 'vertical' }} rows={3} placeholder='Any notes...' value={form.notes} onChange={e => set('notes', e.target.value)} />
        </div>
